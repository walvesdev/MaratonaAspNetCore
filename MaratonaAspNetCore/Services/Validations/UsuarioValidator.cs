...
namespace ProjetoBaseMVC.Model.Validations
{
    ...
    public class UsuarioValidator : AbstractValidator<Usuario>
    {
        public UsuarioValidator()
        {
            ...
            RuleFor(p => p.Permissao.NivelAcesso).NotEmpty().WithMessage("Informe a permissão do usuario!").Length(50).WithMessage("A permissão pode conter no maximo 50 caracteres");
